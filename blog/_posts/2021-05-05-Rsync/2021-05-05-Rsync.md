...
글을 작성하다 보니 학교 서버관리할 때가 생각이 난다.

교수님이 주기적으로 서버 백업해놓으라고 하셔서 직접 손으로 했는데......

[runit님 - RSYNC 리눅스 서버 자동 백업하기](https://www.runit.cloud/2020/06/bash-rsync.html) 요것만 따라 했어도 편하게 백업할 수 있었을 텐데.... ㅜㅜㅜㅜㅜ
